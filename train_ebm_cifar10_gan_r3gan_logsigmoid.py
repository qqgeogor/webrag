    ...
    for epoch in range(start_epoch,args.epochs):
        ...
        for i, (real_samples, _) in enumerate(tqdm(trainloader)):
            ...
            for _ in range(args.n_critic):  # Train discriminator more frequently
                ...
                d_loss = -F.logsigmoid(realistic_logits)
            ...
            g_loss = -F.logsigmoid(realistic_logits)
            g_loss = g_loss.mean()
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='F:/output/cifar10-ebm-gan-r3gan-logsigmoid')
