    ...
    for epoch in range(start_epoch,args.epochs):
        ...
        for i, (real_samples, _) in enumerate(tqdm(trainloader)):
            ...
            for _ in range(args.n_critic):  # Train discriminator more frequently
                ...
                contexts = discriminator.forward_feature(real_samples)
                # contexts = None
            ...
            # p2 = discriminator.forward_feature(fake_samples)
...
def save_gan_samples(generator, discriminator, epoch, output_dir, device, batch_size=36,real_samples=None):
    ...
    with torch.no_grad():
        z = torch.randn(batch_size,args.latent_dim, device=device)
        contexts = discriminator.forward_feature(real_samples[:batch_size])
        # contexts = None
        fake_samples = generator.generate(z,contexts)
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='F:/output/cifar10-ebm-gan-r3gan-vit-cls')
