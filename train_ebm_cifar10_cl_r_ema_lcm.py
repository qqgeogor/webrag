...
def train_ebm(args):
    ...
    for epoch in range(start_epoch,args.epochs):
        ...
        for i, (images, _) in enumerate(tqdm(trainloader)):
            ...
            # optimizer.param_groups[0]['lr'] = lr_schedule[it]
            ...
            # img2 = images
            log_steps = torch.linspace(0, torch.log(torch.tensor(sampler.num_steps)), sampler.num_steps)
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='F:/output/cifar10-ebm-cl-r-ema-lcm')
