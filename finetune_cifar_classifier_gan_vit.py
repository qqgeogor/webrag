...
from train_ebm_cifar10_gan_r3gan_ctrl_vit import EnergyNet
...
def get_args_parser():
    ...
    # System parameters
    parser.add_argument('--data_path', default='../cnn_lp/data', type=str)
    parser.add_argument('--output_dir', default='./output/cifar10-classifier-gan')
    parser.add_argument('--pretrained_path', default='./output/cifar10-ebm-gan-r3gan-ctrl/ebm_gan_checkpoint_1180.pth', 
